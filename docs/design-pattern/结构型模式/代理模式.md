...
![](assets/代理模式/05e90d1708efb71dc03035c63f2a202e_MD5.png)
...
Java中提供了一个动态代理类Proxy，Proxy并不是上述所说的代理对象的类，而是提供了一个创建代理对象的静态方法（newProxyInstance方法）来获取代理对象。

在保持卖票接口和火车站类不变的情况下，改变代理类：
...
- 代理类（$Proxy0）实现了SellTickets。印证了之前说的真实类和代理类实现同样的接口。
...
public final class $Proxy0 extends Proxy implements SellTickets {
    ...
    static {
        try {
            ...
            m3 = Class.forName("com.qaomuu.proxy.dynamic.jdk.SellTickets").getMethod("sell", new Class[0]);
